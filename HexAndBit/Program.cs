...
Console.WriteLine(" Hex to Binary Please press 'h'");
...
while (input == "h")
{
    ...
    {
        case "b":
            Console.Write("Enter BinaryValue:");
            var readBinaryValue = Console.ReadLine()!;
            var value1 = ConverterHexAndBinary.BinaryStringToHexString(readBinaryValue);
            Console.WriteLine($"HexValue:{value1}");
            break;
